<template>
  <div class="shadow-md bg-white">
    <div class="container mx-auto relative">
      ...
      <input type="text" :value="search" @input="store.commit('setSearch', $event.data || '')" placeholder="Enter issue link, label or language" class="w-full py-5 pl-20 pr-32 text-4xl border-0 focus:ring-0 font-light placeholder-gray-500 focus:placeholder-gray-300" />
...
if (issueParams) {
  store.commit('setSearch', `https://github.com/${issueParams[1]}/${issueParams[2]}/issues/${issueParams[3]}`)
}
</script>